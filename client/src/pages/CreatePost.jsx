  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
            ...
            <p className='mt-2 text-[#666E75] text-[16px] max-2-[500px]'>Create imaginative and visually stunning images through DALL-E AI and share with the community.</p>
        </div>
        ...
        <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
          ...
          <div className='mt-10'>
            ...
            <button type='submit' className='mt-3 textw-white bg-[#6469FF] font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center'>
